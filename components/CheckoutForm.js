          ...
          <div className="w-full md:w-2/3 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input placeholder="Your Name" className="border p-2 rounded" required />
                <input placeholder="Phone Number" className="border p-2 rounded" required />
                <input placeholder="Address" className="border p-2 rounded md:col-span-2" required />
                <input placeholder="Town / City" className="border p-2 rounded" required />
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input placeholder="Pick-up Location" className="border p-2 rounded" required />
                <input type="date" className="border p-2 rounded" required />
                <input type="time" className="border p-2 rounded" required />
                <input placeholder="Drop-off Location" className="border p-2 rounded" required />
                <input type="date" className="border p-2 rounded" required />
                <input type="time" className="border p-2 rounded" required />
              </div>
            </section>
              ...
              <div className="space-y-4">
                ...
                {paymentMethod === "card" && (
                  <div className="grid gap-4 mt-4">
                    <input placeholder="Card Number" className="border p-2 rounded" required />
                    <div className="grid grid-cols-2 gap-4">
                      <input placeholder="MM/YY" className="border p-2 rounded" required />
                      <input placeholder="CVC" className="border p-2 rounded" required />
                    </div>
                    <input placeholder="Card Holder Name" className="border p-2 rounded" required />
                  </div>
                )}
              </div>
            </section>
